...
最近は **Go** を学習中で、Cloudflare Pages で[技術ブログ](https://manamana-blog.pages.dev)も運営しています。

> **Fun fact:** 元 Overwatch 2 Grand Master (PC)

<div align="center">

[![Blog](https://img.shields.io/badge/Blog-manamana--blog-2ea44f?style=for-the-badge&logo=cloudflare&logoColor=white)](https://manamana-blog.pages.dev)
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=rails,ruby,go,aws,cloudflare,docker,terraform,githubactions,circleci,sentry,linux,bash,nginx,git,neovim,vscode&theme=dark&perline=8" alt="Tech Stack" />
</div>
